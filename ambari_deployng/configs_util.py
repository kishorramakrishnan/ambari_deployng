...
def update_http_conf(cluster_name,balancer_hosts,ranger_admin_port,load_balancer_host):
    ...
    final_temp_file = "conf/ranger_loadbalancer_final.conf"
    ssh_utils.copy_file("conf/ranger_loadbalancer.conf",final_temp_file)
...
def replace_string_in_file(file_name,original_string,replacement_string):
    ...
    with open(file_name, 'r+') as file:
        ...
        logger.info("after replacing hosts {0}".format(file_content))
